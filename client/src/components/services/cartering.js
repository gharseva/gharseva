...
const Catering = () => {
  ...
  const ServiceScroll = () => {
    // window.location.href = "/";
    setTimeout(() => {
      const element = document.getElementsById("service-div");
      if (element) {
    ...
    <>
      ...
      <div className="navbar-home">
        ...
        <div className="home-h-div">
          ...
          <h3 className="home-h" onClick={ServiceScroll}>
            Services
          </h3>
          <h3
            className="home-h"
      ...
      <div className="catering-main-div">
        <article className="blog-post">
          {" "}
          <div className="blog-post__img">
            <img
              src="https://img.freepik.com/free-photo/closed-metal-pots_1203-2059.jpg?w=1380&t=st=1677934429~exp=1677935029~hmac=617eb4849ab00f7989b4e1cde5d89edfdc3dcb849197054d8abd31b6a89d027f"
              alt=""
            />
          </div>
          <div className="blog-post__info">
            <h2 className="blog-post__title">Catering Service</h2>
            <p>
              Book a professional caterer for your next event and let us take
              care of the food and beverages while you focus on enjoying the
              occasion.
            </p>{" "}
            <Link
              component={RouterLink}
              sx={{ textTransform: "none", textDecoration: "none" }}
              to={`/catering/cateringbooking`}
            >
              <h4 className="blog-post__cta">Book Now</h4>
            </Link>
          </div>{" "}
        </article>
      </div>
